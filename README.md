- Báo cáo: Sorting Report.docx
- Mã nguồn: 
   main.py: File chương trình chính dùng để chạy thực nghiệm và đo thời gian
   sorting.py: file chứa mã nguồn các thuật toán (Quick,Heap,Merge,numpysort)
- Dữ liệu thử nghiệm: 
